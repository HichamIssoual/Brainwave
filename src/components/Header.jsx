...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 lg:backdrop-blur-0 bg-n-8/90 w-full">
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4 justify-between relative">
        ...
        <nav
          ...
          } max-lg:flex-col max-lg:absolute max-lg:top-20 max-lg:w-full max-lg:text-center max-lg:right-0 lg:flex items-center justify-center text-n-3 text-sm`}
        >
          {navigation.map((item) => {
            return (
              <a
